...
function showHint(elementID,hintText) {
	$('#'+elementID).validationEngine('showPrompt',hintText,'pass');
}
...
(function($) {
    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                switch (rules[i]) {
					...
					case "customCalFunc": 										/*amin*/
						required = true;										  /*amin*/
						errorMsg = methods._required(field, rules, i, options);  /*amin*/
						break;            										/*amin*/
                    case "required":
                        required = true;
            ...
            if(!required){
            	//if(field.val() == "") options.isError = false;					/*amin*/ /*The problem is this line to call a single funcCall! I commented this line*/
            }			
        ...
        _required: function(field, rules, i, options) {
			/*var typeVar=field.attr("type");
			if(field.attr("type")=="")
				typeVar="select-one"       
			alert(typeVar);
			alert(field.val());*/
			
            switch (field.attr("type")) {            /*amin field.attr("type")*/
                case "text":
                case "password":
                case "textarea":
                case "file":
        ...
        _calculatePosition: function (field, promptElmt, options) {
            ...
            switch (options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        // Is the form contained in an overflown container?
                        promptleftPosition += -157; 			/*-30*//*amin*//*-200*/
                    else {
                        promptleftPosition += -157; 			/*-30*//*amin*//*-157*/
                        promptTopPosition += -promptHeight;  /*-2*//*amin*//*-promptHeight*/
                    }
                    break;
                case "topLeft":
